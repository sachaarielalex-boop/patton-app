...
def _folder_picker_body(item):
    ...
    st.markdown(
        ...
        'Move &laquo;{} &mdash; {}&raquo; into a tenant folder. Pick a destination:</div>'.format(
...
def _render_add_to_folder_picker(history):
    """When the user clicks '+' on a past proposal, show a popup to move it into a folder."""
